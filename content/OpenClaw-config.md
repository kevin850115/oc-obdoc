...
本文档包含敏感配置信息（API 密钥、令牌等），请妥善保管，不要公开分享！
...
| 设备身份 | `/home/admin/.openclaw/identity/device.json` |
| 设备认证 | `/home/admin/.openclaw/identity/device-auth.json` |
| 定时任务 | `/home/admin/.openclaw/cron/jobs.json` |
| 执行批准 | `/home/admin/.openclaw/exec-approvals.json` |
| 配对设备 | `/home/admin/.openclaw/devices/paired.json` |
